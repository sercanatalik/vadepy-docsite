...
[DiscountCurve](../api/rates/curves#discountcurve),
[LineCurve](../api/rates/curves#linecurve), and composite curves all follow
the same rule. The input node type determines the output type.

## AD in Practice

You rarely create Dual-valued curves manually. The
[Solver](../api/rates/solver#solver) does this automatically during calibration:
