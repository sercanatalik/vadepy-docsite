---
title: "Bonds"
description: "Compute settlement-aware analytics for a [FixedRateBond](../../api/credit/instruments.md#fixedratebond)"
---

Compute settlement-aware analytics for a [FixedRateBond](../../api/credit/instruments#fixedratebond)
...
See [ZeroCouponBond](../../api/credit/instruments#zerocouponbond) API reference.
...
See [StepUpBond](../../api/credit/instruments#stepupbond) API reference.
...
See [AmortizingBond](../../api/credit/instruments#amortizingbond) API reference.
...
See [PIKBond](../../api/credit/instruments#pikbond) API reference.
...
See [CappedFloatRateNote](../../api/credit/instruments#cappedfloatratenote) API reference.
