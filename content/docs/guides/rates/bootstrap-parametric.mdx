...
description: "Use [bootstrap](../../api/rates/solver.md#bootstrap) for node-by-node curve stripping"
---

Use [bootstrap](../../api/rates/solver#bootstrap) for node-by-node curve stripping
via Brent root-finding, and the [NelsonSiegel](../../api/rates/curves#nelsonsiegel)
...
The [SmithWilson](../../api/rates/curves#smithwilson) model is used in Solvency II
