...
[IRS](../../api/rates/instruments#irs), FRA, ZCS, OIS, and Deposit pricing against a
[DiscountCurve](../../api/rates/curves#discountcurve) calibrated from USD SOFR market
data.
...
[FRA](../../api/rates/instruments#fra) `.rate()` returns the implied forward rate in
decimal form.
...
Price a 3-year zero coupon swap. [ZCS](../../api/rates/instruments#zcs) `.rate()`
...
Price a 2-year overnight index swap. [OIS](../../api/rates/instruments#ois) is
...
Price a 1-month deposit. [Deposit](../../api/rates/instruments#deposit) `.rate()`
