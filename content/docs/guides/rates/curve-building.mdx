...
[DiscountCurve](../../api/rates/curves#discountcurve) and then reconstructs it with
...
[LineCurve](../../api/rates/curves#linecurve) stores zero rates directly instead of
...
[ForwardCurve](../../api/rates/curves#forwardcurve) stores instantaneous forward
