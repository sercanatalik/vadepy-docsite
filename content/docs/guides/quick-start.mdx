---
title: "Quick Start"
description: "Build a USD SOFR discount curve, calibrate it to market instruments, price swaps, and compute risk -- all in one workflow. This guide uses [DiscountCurve](../api/curves.md#discountcurve) for curve construction and [Solver](../api/solver.md#solver) for calibration."
---

Build a USD SOFR discount curve, calibrate it to market instruments, price swaps, and compute risk -- all in one workflow. This guide uses [DiscountCurve](../api/curves#discountcurve) for curve construction and [Solver](../api/solver#solver) for calibration.
...
The calibrated curve now prices all input instruments back to their market quotes. You can verify this by checking that the [SolverResult](../api/solver#solverresult) residuals are near zero:
