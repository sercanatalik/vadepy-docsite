---
title: "Serialization"
description: "All major curve types and the [Solver](../api/solver.md#solver) support JSON"
---

All major curve types and the [Solver](../api/solver#solver) support JSON
...
[DiscountCurve](../api/curves#discountcurve) for the primary example.
...
[LineCurve](../api/curves#linecurve) and parametric curve types like
[NelsonSiegel](../api/curves#nelsonsiegel). Each type's `from_json()` is a
...
Persisting a calibrated [Solver](../api/solver#solver) captures the full
